...
public class GameEngine {
	...
	// TODO: add methods that set mode to MOVE or ATTACK here - to be called from
	// the controller
	...
	public void processSelectedTile(int x, int y) {
		/**
		 * 3 cases: #1: The player click on the tile to select an existing insect to
		 * manipulate - currentInsect == null #2: The player click on the tile to -
		 * place the insect: currentInsect.getCoordinate == null - move the insect
		 * there: valid selectedTile has no insect on it - attack the insect on that
		 * tile: valid selectedTile has an insect on it (MEH) #3: There's nothing on
		 * that tile
		 */
	...
	public void setCurrentInsect(Tile selectedTile) {
